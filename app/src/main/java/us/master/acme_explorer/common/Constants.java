...
public final class Constantes {
    public final static String[] ciudades = {"Tirana", "Berlín", "Andorra La Vieja", "Ereván",
            "Viena", "Bakú", "Bruselas", "Minsk", "Sarajevo", "Sofía", "Praga", "Zagreb",
            "Copenhague", "Bratislava", "Lublijana", "Madrid", "Tallín", "Helsinki", "París",
            "Tiflis", "Atenas", "Budapest", "Dublín", "Reikiavik", "Roma", "Riga", "Vaduz",
            "Vilna", "Luxemburgo", "Skopje", "La Valeta", "Chisinau", "Mónaco", "Podgorica",
            "Oslo", "Amsterdam", "Varsovia", "Lisboa", "Londres", "Bucarest", "Moscú",
            "Ciudad De San Marino", "Belgrado", "Estocolmo", "Berna", "Kiev", "Ciudad Del Vaticano"};
    public final static String[] lugarSalida = {"Sevilla", "Málaga", "Faro", "Barcelona",
            "Madrid", "Valencia"};
    public final static String filtroPreferences = "Filtro", fechaInicio = "FechaInicio",
            fechaFin = "FechaFin";
